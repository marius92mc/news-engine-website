...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (System.Web.HttpContext.Current.User.Identity.IsAuthenticated && User.IsInRole("Editor"))
        {                         // a doua conditie e ca sa fie true DOAR daca acel user are rol de editor
    ...
    protected void Insereaza(object sender, EventArgs e)
    {
            ...
            try
            {
                if (FileUploadControl.PostedFile.ContentType == "image/jpeg")
                {
                    if (FileUploadControl.PostedFile.ContentLength < 102400)
                    {
                        ...
                        Image newImage = ScaleImage(image, 200, 200);
        ...
        try 
        {
            ...
            SqlCommand command = new SqlCommand("INSERT INTO [News] ([TITLE], [DESCRIPTION], [EDITOR], [ID_CATEGORY], [BODY], [IMAGE]) VALUES (@TITLE, @DESCRIPTION, @EDITOR, @ID_CATEGORY, @BODY, @IMAGE)", connection);
            ...
            try
            {
                ...
                Response.Redirect("~/Default.aspx?insert=1");
